...
const COMPLAINT_CATEGORIES = ["ACADEMIC", "FACILITY", "HARASSMENT", "OTHER"];
    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl space-y-6 mt-14">
      ...
      <Card className="border border-muted rounded-3xl overflow-hidden shadow-md">
        <CardHeader className="border-b bg-muted/20">
          ...
          <CardDescription>
            Submit complaints or administrative feedback securely to
        ...
        <CardContent className="p-6">
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="flex items-start gap-3 p-4 border border-dashed border-muted rounded-2xl bg-muted/20">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground leading-normal">
                        Check this box if you want to hide your student ID,
                        name, and email from university administrators.
                      </p>
                    </div>
                  </div>
                )}
            ...
            {isAnonymousValue ? (
              <div className="flex gap-3 bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 border border-indigo-200/50 p-4 rounded-2xl text-xs leading-relaxed animate-in fade-in slide-in-from-top-1">
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    Your student identifiers will be completely redacted from
                    this record before it is delivered to administrators. The
                    system assigns a secure hash/reference code so you can still
                    track status.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-200/50 p-4 rounded-2xl text-xs leading-relaxed">
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    Your name, student ID, and email address will be visible to
                    university administrators reviewing this complaint. This
                    facilitates follow-up communication if further clarification
                    is required.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              <Button
                type="submit"
                className="rounded-xl h-11 px-5 gap-2 font-semibold shadow-md bg-red-600 hover:bg-red-700 text-white"
                disabled={isLoading}
              >
                Submit Complaint
              </Button>
