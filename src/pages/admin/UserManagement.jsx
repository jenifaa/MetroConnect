...
export default function UserManagement() {
  ...
  const handleRoleChange = async () => {
    ...
    try {
      await updateUserStatus({
        id: userToPromote.id || userToPromote._id,
        role: targetRole,
      }).unwrap();
  ...
  const handleStatusToggle = async () => {
    ...
    try {
      await updateUserStatus({
        id: userToToggleStatus.id || userToToggleStatus._id,
        status: targetStatus,
      }).unwrap();
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="No student profiles are registered on this database."
        />
      ) : (
      ...
      <ConfirmDialog
        ...
        description={`Confirm changes to update authorization level for ${userToPromote?.name} to ${
          userToPromote?.role === "ADMIN" ? "USER (student)" : "ADMIN"
        }.`}
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to ${
          userToToggleStatus?.status === "suspended" ? "unsuspend" : "suspend"
