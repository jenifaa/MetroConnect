...
export default function PostFormPage() {
  ...
  const { data: postResponse, isLoading: isFetching } = useGetPostByIdQuery(
    postId,
    {
      skip: !isEditMode,
    },
        ...
        <CardContent className="p-6">
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            <FieldGroup className="space-y-4">
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    ...
                    <Input
                      {...field}
                      placeholder="e.g. Tips for upcoming final examinations"
              ...
              <p className="font-semibold">Image Upload (Optional)</p>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              <Button
                type="submit"
                className="rounded-xl h-11 px-5 gap-2 font-semibold shadow-md"
                disabled={isSubmitting}
              >
                {isEditMode ? (
