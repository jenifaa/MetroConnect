...
export default function PostDetailPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl mt-14">
        ...
        <div className="text-center mt-4">
          <Button onClick={() => navigate("/all-posts")} variant="outline" className="rounded-xl">
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl space-y-6 mt-14">
      {/* Back button */}
      <div>
        <Button onClick={() => navigate("/all-posts")} variant="ghost" className="rounded-xl gap-2 text-muted-foreground">
